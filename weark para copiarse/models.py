...
class Presupuesto(db.Model):
    ...
    # Cuándo el personal abrió la ficha del presupuesto y "leyó" la notificación de respuesta cliente
    ...
    # FacturaDirecta (albarán en FD generado desde este presupuesto)
    fd_deliverynote_uuid = db.Column(db.String(64), nullable=True)  # uuid del albarán en FacturaDirecta
    fd_deliverynote_doc_number = db.Column(db.String(100), nullable=True)  # número asignado por FD (formateado)
    fd_deliverynote_sent_at = db.Column(db.DateTime, nullable=True)
    fd_deliverynote_last_error = db.Column(db.Text, nullable=True)
...
class Factura(db.Model):
    ...
    # FacturaDirecta (albarán en FD generado desde este albarán de retirada)
    fd_deliverynote_uuid = db.Column(db.String(64), nullable=True)
    fd_deliverynote_doc_number = db.Column(db.String(100), nullable=True)
    fd_deliverynote_sent_at = db.Column(db.DateTime, nullable=True)
    fd_deliverynote_last_error = db.Column(db.Text, nullable=True)
