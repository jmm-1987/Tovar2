...
def preparar_datos_imprimir_factura(factura_id):
    ...
    # Intentar obtener el cliente completo si no hay pedido pero hay NIF
    cliente_completo = None
    if not pedido and factura.nif:
        cliente_completo = Cliente.query.filter_by(nif=factura.nif).first()
    elif pedido and pedido.cliente:
        cliente_completo = pedido.cliente
